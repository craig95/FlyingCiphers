...
class CeaserDecoder:
    ...
    def __init__(self, training_data):
        self.bi_counts = DefaultDict(1)
        self.tri_counts = DefaultDict(1)
...
print(test.decode('2XQM5QN7A10QYUXXU104M0P59146T1R5TM4Q5M0PNQOM4QR7X01661NQ5QQ0NA6TQM7564MXUM0S18Q40YQ06M0P2XQM5QNQ8USUXM06'))